...
<body>
                        ...
                        <section class="panel">
                                      <header class="panel-heading tab-bg-primary ">
                                        <ul class="nav nav-tabs">
                                          ...
                                          <li>
                                            <a href="#about" data-toggle="tab">Transactions</a>
                                          </li>
                                          <li>
                                            <a href="#profile" data-toggle="tab">Profile</a>
                                          </li>
                                          <li>
                                            <a href="#payer" data-toggle="tab">Payer</a>
                                          </li>
                                        </ul>
                                      </header>
                                      <div class="panel-body">
                                        <div class="tab-content">
                                          <div class="tab-pane active" id="home">
                                            Voici le montant total de votre argent en ligne : ({{$recues->sum('montant')-$envoies->sum('montant')}})
                                          </div>
                                          <div class="tab-pane" id="about">Dernières Transactions : 
                                          <p>Paiement : ({{$envoies->count()}})</p>

                                          
                                          
                                          @foreach($envoies as $envoie)
                                              <p>Envoie de {{$envoie->montant}} à {{$envoie->recepteurname()}} pour {{$envoie->motif}} le {{date('d-m-Y', strtotime($envoie->created_at))}};</p>
                                          @endforeach
                                          ...
                                          <div class="tab-pane" id="profile"><p>Nom : {{Auth::user()->name}} </p>
                                            Email : {{Auth::user()->email}}</div>
                                          <div class="tab-pane" id="payer">
                                            <!-- Debut du Formulaire de règlement d'achat -->
                                            <div class="row">
                                              <div class="col-lg-12">
                                                <section class="panel">
                                                    ...
                                                    <div class="form">
                                                      <form class="form-horizontal" method="POST" action="{{ route('transactions.store') }}">
                                                        ...
                                                        <div class="form-group ">
                                                          <label for="motif" class="control-label col-lg-2">Raison de l'envoi : <span class="required">*</span></label>
                                                          <div class="col-lg-10">
                                                            <input class="form-control" id="motif" name="motif" minlength="5" type="text" required />
                                                          </div>
                                                        </div>
                                                        <div class="form-group ">
                                                          <label for="motif" class="control-label col-lg-2">Montant : <span class="required">*</span></label>
                                                          <div class="col-lg-10">
                                                            <input class="form-control" id="motif" name="montant" type="number" required />
                                                          </div>
                                                        </div>
                                                        <div class="form-group">
                                                          <label class="control-label col-lg-2" for="id_rec">Envoyé à : </label>
                                                          <div class="col-lg-10">                                                            <select id="id_rec" name="id_rec" class="form-control input-lg m-bot15">
                                                            @php
                                                                $users = App\User::all();
                                                            @endphp
                                            ...
                                            <!-- Fin du Formulaire de reglement d'achat -->
                                          </div>
                                        </div>
                                      </div>
                                    </section>
    ...
    <!-- jquery validate js -->
    <script type="text/javascript" src="{{ asset('niceadmin/js/jquery.validate.min.js') }}"></script>
    <!-- custom form validation script for this page-->
    <script src="{{ asset('niceadmin/js/form-validation-script.js') }}"></script>
</body>
</html>